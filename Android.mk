...
BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU SK8S_DEBUG_UI RECOVERY_DATAMEDIA_AND_SDCARD TARGET_DEVICE_E970 TAP_TO_SELECT KYLE_TOUCH_RECOVERY
...
ifeq ($(TARGET_PRODUCT), full_geebus)
include $(CLEAR_VARS)
